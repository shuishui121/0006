...
export const PUZZLE_CONFIGS: PuzzleConfig[] = [
  {
    ...
    clue: '3',
    data: {
      powerSource: { x: 150, y: CY },
      powerTarget: { x: CANVAS_WIDTH - 150, y: CY },
      slots: [
        { id: 'slot1', x: 280, y: CY, allowedRadii: [55, 70, 85] },
        { id: 'slot2', x: 420, y: CY - 80, allowedRadii: [40, 55, 70] },
        { id: 'slot3', x: 560, y: CY, allowedRadii: [55, 70, 85] },
        { id: 'slot4', x: 700, y: CY + 60, allowedRadii: [40, 55, 70] },
        { id: 'slot5', x: 840, y: CY, allowedRadii: [55, 70] },
      ],
      availableGears: [
        { radius: 40, teeth: 12 },
        { radius: 40, teeth: 12 },
